...
- **No human check, bypass, or dispute path.** A person misclassified as a bot
  ...
  Phase 2)` until [M58](m58.md). Phase 3 declined the redirect-path work area
  outright — [D108](../../../Plan.md#phase-3-decisions) — and Plan.md's list no
...
until [M58](m58.md), which took the phase number off the promise rather than
moving it on ([D108](../../../Plan.md#phase-3-decisions)) — and nobody
