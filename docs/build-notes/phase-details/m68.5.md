...
settings)*.
**Discharges:** [F334](../deferred-findings.md#closed) — an add-on cannot make an
...
- **Which invocations may fetch at all is decided here, and the redirect path
  ...
  *(**Amended 2026-08-26, a fact.** This read "For a **route** handler there is
  ...
  said so before this milestone touched it. Found by M68.5's first reviewer,
  ...
  was wrong. See decisions.md.)* For a **redirect-class** invocation the budget is M66's
