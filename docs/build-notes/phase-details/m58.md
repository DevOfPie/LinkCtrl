...
- Every row **open in [deferred-findings.md](../deferred-findings.md) when this
...
- `internal/store/migrations/00200_identity.sql:20` and
  ...
  carry a `(Phase 3)` marker**. SSO is **not** built this phase; M53 discharges
...
- **The bot-bypass promises, which D108 falsified by declining area D.** Seven
  ...
  **the assertion message in `test/integration/bots_test.go`**, and **both of
  [M32.5](m32.5.md)'s** — its *deliberately not in this milestone* bullet and
  its *Risks* paragraph. Each becomes a promise about a later phase or loses its
  phase number. Two further mentions in [decisions.md](../decisions.md) stay:
...
this close leaves fourteen for work — *eighteen as it turned out, M57.5 having
...
Scheduled at [M57.9](m57.9.md)'s triage
([F251](../deferred-findings.md#closed), [D201](../decisions.md)). This is
[workflow.md](../workflow.md#an-issue-is-found--any-time-any-source)'s trigger
