...
- **`internal/store/migrations/00600_phase2_dormant.sql:59`** describes the QR
  ...
  M41 built the feature and left the comment describing a blob it did not fill.
  **[M50.5](m50.5.md) makes the *logo reference* half true**, so what this sweep
  ...
  M45 — which is the same lesson F44 taught and is why this list is counted
...
- **The bot-bypass promises, which D108 falsified by declining area D.** Four
  ...
  is Phase 3, per Not in Phase 2"*), and `docs/SECURITY.md`'s corresponding row.
  Each becomes a promise about a later phase or loses its phase number.
  *(Added 2026-08-07, from review. This list was headed "counted rather than
  ...
  [M52](m52.md)'s own risk section warns about, reproduced inside the milestone
