...
- **`internal/store/migrations/00600_phase2_dormant.sql:59`** describes the QR
  ...
  **[M50.6](m50.6.md) makes the *logo reference* half true**, so what this sweep
...
this close leaves fourteen for work, and the plan spends all fourteen — a target
...
[M50.5](m50.5.md) and [M50.6](m50.6.md) on the day it was written, by a review
