...
- **The select's closed face is the chevron alone.** Owner-amended from B1 as
  ...
  and the opened list is unchanged: disabled placeholder first, then every
  workspace that is not current. A sighted reader gets the affordance from the
  boundary and the arrow; a screen reader loses nothing.
