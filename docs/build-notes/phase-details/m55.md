...
[D149](../../../Plan.md#phase-3-decisions), owner-set 2026-08-08 at
[M52](m52.md)'s step 1: the checker is **on by default and asks at first run**,
overruling a recommendation of off. `docs/SECURITY.md:73` — *"No telemetry, no
