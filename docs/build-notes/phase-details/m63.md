...
- **The storage host functions (M61's declared limb) become real**: queries an
  ...
  [F258](../deferred-findings.md#closed)'s subject, so this file names the
...
- **F288 — an add-on that parks a setting earns a failed load, and nothing sweeps.**
  *(Added 2026-08-20 by the reopening, D269. D279. Amended 2026-08-21 by D282,
  ...
  [operations.md](../../operations.md), which they may never type at all. So a
  ...
  **Done is detect and refuse, not sweep.** The confinement post-condition's
  ...
  [deployment.md](../../deployment.md) asks for — is recorded as a member with
  ...
  **The residue is stated rather than absorbed.** An uninstalled add-on's parked
  ...
  [operations.md](../../operations.md) carries the query that lists the scopes, and
  [deployment.md](../../deployment.md) states the residue where an operator meets
