...
**One row is open — [M46.6](m46.6.md), reopened on [F209](../deferred-findings.md#open) —
and [M57.9](m57.9.md)'s reopened run follows it. 0.3.0 is written and not yet
tagged.** Four work areas, chosen 2026-08-06: identity and account
...
| [M46.6](m46.6.md) | The workspace pair reads as one control | M46 · M46.5 | in progress (reopened) |
