...
| [M26.5](m26.5.md) | Dashboard header: identity menu and notification bell | — (before M27) | not started |
...
| [M32.9](m32.9.md) | **Mid-phase adversarial review** | M21–M32.5 | not started |
