...
- **The manifest format's three obligations are met, because a new key is what
  ...
  rule exists to catch. *(Amended 2026-08-30 at [M69.9](m69.9.md) — a fact. The
  ...
  omitted one — M68.5's `origin` — which is how the gap was found and is now
...
- **Nothing appears on a stock instance.** No add-ons directory, or no installed
  ...
  the comparison and counted (D402, [F349](../deferred-findings.md#closed)).
