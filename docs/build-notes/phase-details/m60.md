...
- **An add-on is a `.wasm` file plus a manifest**, loaded from an
  ...
  cost". *(Amended 2026-08-30 at [M69.9](m69.9.md) — a fact. Four of the five
  still assert as written and their tests are green. The fifth, **no table**, was
  narrowed deliberately by M65 and M68 into a bound: an instance with no add-ons
  ...
  `internal/addon/absence_test.go` and in [D342](../decisions.md), but not into
