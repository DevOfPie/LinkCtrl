...
- **F248 — the membership check is not a pipeline.** *(Added 2026-08-20 by the
  reopening, D269, on [F291](../deferred-findings.md#closed).)* The check as
  ...
  pass — named rather than cited by line, the way D218 withdrew a citation M60
...
- **F253 — and the guard in `release-check` is not a pipeline either.** *(Added
  ...
  [F304](../deferred-findings.md#closed) lists. A false 141 makes the `elif`
  ...
  is in spec here — M59's own claim, not the subsystem. The other eight sites
