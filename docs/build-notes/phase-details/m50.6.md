...
it is. The second code on `/qr-styled` now draws the disc in the middle of it at
level H. M50.5's `demoCoverage()` row is reworded to say what a reader now sees
