...
this note was written and is **1360** in two halves of 680 since M49's second
...
[F223](../deferred-findings.md#closed) was filed against, and the owner
...
`L` in that explanation is no longer reachable, since [D187](../decisions.md)
...
([F215](../deferred-findings.md#closed)): *"it should be as big as possible
...
([F223](../deferred-findings.md#closed), Open when this was written). Uploading one forces error correction to
