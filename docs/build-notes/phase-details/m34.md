# M34 — Routing rules: conditions and first-match evaluation

**Depends on:** [M23](m23.md) [M30](m30.md) [M33](m33.md). **Discharges:** Redirect
...
- Every rule destination passes the full [M30](m30.md) tier check.
- Rule CRUD invalidates snapshots across replicas ([M23](m23.md)).
