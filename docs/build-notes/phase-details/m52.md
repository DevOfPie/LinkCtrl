...
user-uploaded file — a QR logo. Whether it lives in a column, on a filesystem
path or in an object store is M50.5's decision, and only the first is removed by
a cascade.
