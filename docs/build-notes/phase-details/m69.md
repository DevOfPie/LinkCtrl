...
**[M68.5](m68.5.md)** *(hard, added 2026-08-25 — a relying party's discovery
fetch, token exchange and JWKS fetch are outbound requests this foundation could
not make, which is [F334](../deferred-findings.md#closed) and is why this milestone
could not start)*; [M68](m68.md) *(ordering preference — installing through the manager page is the
...
- **The add-on consumes only the published SDK** at an **immutable, publicly
  ...
  *(**Amended 2026-08-25, owner-answered.** This read "at a tagged release", which
  ...
  [M70](m70.md) cuts after this milestone and after [M69.9](m69.9.md). A Go
  ...
  shows an author something nobody would tell them to type — is paid at M70,
...
- **The fixture reproduces that release on any machine, not only on the one that
  ...
  *(**Added 2026-08-28, on the owner's answer, under this milestone's own
  number.** M69 landed at `d421339` and CI's *Integration tests* job then failed
  ...
  [F348](../deferred-findings.md#closed). The owner reopened M69 rather than
