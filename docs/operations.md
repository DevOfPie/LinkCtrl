...
LNK-F-0180, **closed at 0.3.0** together
with LNK-F-0185, the same defect at the
...
- **The dimension rollup is expensive and gets worse.** It recomputes whole days
  ...
  LNK-M-0042 split the cadences, and this paragraph
